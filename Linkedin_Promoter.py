...
# TODO : Add those args to argparser
"""
...
def click(by, what_to_click):
    ...
    while not clicked and tries < MAX_CLICK_TRIES:
        try:
            ...
            tries += 1
            print "[+] Can't click on ", what_to_click, " ! (" + str(tries) + "/" + str(MAX_CLICK_TRIES) + ") Trying Again !"
            sleep(1)
...
def menu():
    ...
    if choice == 1:
        ...
        print "=" * 80
        keywords = raw_input("[+] Please Enter your Keywords separated by space :").split()
        max_accounts = input("[+] Enter Max accounts to scrap (ex :100):")
